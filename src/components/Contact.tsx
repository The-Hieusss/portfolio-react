    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex flex-wrap justify-center gap-10">
          {/* Phone */}
          <div className="flex-1 min-w-[220px] max-w-xs bg-[#120905]/90 rounded-3xl shadow-lg p-8 text-center text-white relative hover:shadow-[0_0_15px_#fa7636] transition-transform hover:scale-105">
            <div className="flex justify-center mb-4">
              <Phone className="w-8 h-8 text-[#fa7636]" />
            </div>
          ...
          <div className="flex-1 min-w-[220px] max-w-xs bg-[#120905]/90 rounded-3xl shadow-lg p-8 text-center text-white relative hover:shadow-[0_0_15px_#fa7636] transition-transform hover:scale-105">
            <div className="flex justify-center mb-4">
              <Mail className="w-8 h-8 text-[#fa7636]" />
            </div>
            <h3 className="mb-2 font-serif text-xl font-bold text-gold-gradient">
              Email Address
            </h3>
          ...
          <div className="flex-1 min-w-[220px] max-w-xs bg-[#120905]/90 rounded-3xl shadow-lg p-8 text-center text-white relative hover:shadow-[0_0_15px_#fa7636] transition-transform hover:scale-105">
            <div className="flex justify-center mb-4">
              <Link className="w-8 h-8 text-[#fa7636]" />
            </div>
            <h3 className="mb-2 font-serif text-xl font-bold text-gold-gradient">
              Social Links
            </h3>
            <ul className="flex justify-center gap-4 mt-2">
              <li>
                <a
                  ...
                  aria-label="GitHub"
                >
                  <Github className="w-7 h-7 text-[#fceee6] hover:text-[#ffb48a] transition" />
                </a>
              </li>
              <li>
                <a
                  ...
                  aria-label="LinkedIn"
                >
                  <Linkedin className="w-7 h-7 text-[#fceee6] hover:text-[#ffb48a] transition" />
                </a>
              </li>
              <li>
                <a
                ...
                >
                  <Instagram className="w-7 h-7 text-[#fceee6] hover:text-[#ffb48a] transition" />
                </a>
              </li>
            </ul>
            <div className="absolute left-0 top-0 h-2 w-1/3 bg-gold-gradient rounded-tr-3xl" />
      ...
      {/* Decorative numbers */}
      <span className="absolute left-0 bottom-0 text-[8rem] md:text-[12rem] text-[#fa7636]/10 font-serif font-bold select-none pointer-events-none pl-4 pb-2 z-0">
      </span>
      <span className="absolute right-0 top-0 text-[8rem] md:text-[12rem] text-[#fa7636]/10 font-serif font-bold select-none pointer-events-none pr-4 pt-2 z-0">
      </span>
    </section>
  );
}
